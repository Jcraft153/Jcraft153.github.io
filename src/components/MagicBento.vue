    ...
    <article class="bento-card bento-card--repositories" @mousemove="tiltCard" @mouseleave="resetCard">
      ...
      <ul v-else-if="repositories.length" class="repository-list">
        ...
        <li
          ...
          @mouseenter="activeRepositoryId = repository.id"
          @mouseleave="activeRepositoryId = null"
        >
          <a
            :href="repository.url"
            target="_blank"
            ...
            @focus="activeRepositoryId = repository.id"
            @blur="activeRepositoryId = null"
          >
            {{ repository.name }} <span aria-hidden="true">↗</span>
          </a>
          <transition name="repository-popover">
            <span
              v-if="activeRepositoryId === repository.id && repository.description"
              :id="`repository-tooltip-${repository.id}`"
